import { BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureDetailsSource, CreatureSystemData, CreatureSystemSource, CreatureTraitsData } from "@actor/creature/data.ts";
